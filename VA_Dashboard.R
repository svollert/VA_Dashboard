...
ui = bs4DashPage(
  ...
  body = bs4DashBody(bs4TabItems(bs4TabItem(tabName = "dashboard1",
                                            ...
                                            fluidRow(bs4Card(title = "Lorenz Curve", plotlyOutput("lorenzcurve"), width = 6, collapsible = TRUE, collapsed = TRUE, closable = FALSE),
                                                     bs4Card(title = "Class Histogramm", plotlyOutput("histogram"), width = 6, collapsible = TRUE, collapsed = TRUE, closable = FALSE)),
                                            fluidRow(bs4Card(title = "Distribution Plot", plotlyOutput("boxplot"), width = 12, collapsible = TRUE, collapsed = TRUE, closable = FALSE)),
                                            fluidRow(bs4TabCard(id = "Test123", title = "Parallel Coordinates  Line Plot", width = 12, closable = FALSE, status = "primary", 
                                                                bs4TabPanel(tabName = "Parallel Coordinates", plotlyOutput("parcoord")),
                                                                bs4TabPanel(tabName = "Line Plot", plotlyOutput("errorline")))),
                                            fluidRow(bs4TabCard(id = "radar", title = "Radar Chart", width = 6, closable = FALSE, status = "primary",
                                                                bs4TabPanel(tabName = "Absolut", plotlyOutput("radarchart")),
                                                                bs4TabPanel(tabName = "Precision", "Test123")),
                                                     bs4Card(title = "Sun Burst", plotlyOutput("sunburst_plot"), width = 6, closable = FALSE, status = "primary"))),
                                 bs4TabItem(tabName = "dashboard2",
                                            ...
                                            fluidRow(bs4Card(title = "Lorenz Curve", plotlyOutput("lorenzcurve2"), width = 6, collapsible = TRUE, collapsed = TRUE, closable = FALSE),
                                                     bs4Card(title = "Class Histogramm", plotlyOutput("histogram2"), width = 6, collapsible = TRUE, collapsed = TRUE, closable = FALSE)),
                                            fluidRow(bs4Card(title = "Distribution Plot", width = 12, collapsible = TRUE, collapsed = TRUE, closable = FALSE)),
                                            fluidRow(bs4Card(title = "Confusion Wheel", chorddiagOutput("chorddiagramm", height = 500), width = 6, closable = FALSE, status = "primary"),
                                                     bs4Card(title = "Confusion Matrix", plotlyOutput("heatmap", height = 500), width = 6, closable = FALSE, status = "primary")),
                                            fluidRow(bs4Card(title = "Sankey Diagram",plotlyOutput("sankey"), width = 6, closable = FALSE, status = "primary"),
                                                     bs4Card(title = "Treemap", d3tree2Output("treemap"),width = 6, closable = FALSE, status = "primary"))),
