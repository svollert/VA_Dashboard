...
ui = bs4DashPage(
  ...
  body = bs4DashBody(bs4TabItems(bs4TabItem(tabName = "dashboard1",
                                 ...
                                 bs4TabItem(tabName = "information",
                                            ...
                                            fluidRow(bs4Card(title = "Explanation Video", HTML('<center><iframe width="720" height="405" src="https://www.youtube.com/embed/IO7IWTUxK_Y" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>'), width = 6),
